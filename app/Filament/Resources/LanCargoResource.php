...
use App\Filament\Resources\LanCargoResource\Pages;
use App\Filament\Resources\LanCargoResource\RelationManagers;
...
class LanCargoResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->getSearchResultsUsing(fn (string $search): array => Guias::where('guia', 'like', "%{$search}%")->where('aereolinea', 'like', 'LAN_CARGO')->where('status', 'like', 1)->limit(50)->pluck('guia', 'id')->toArray())
    ...
    {
        return [
            'index' => Pages\ListLanCargos::route('/'),
            'create' => Pages\CreateLanCargo::route('/create'),
            'edit' => Pages\EditLanCargo::route('/{record}/edit'),
        ];
    }
}
